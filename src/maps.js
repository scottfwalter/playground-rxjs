...
const testMergeMap = mergeValues.pipe(mergeMap(value => of(value).pipe(delay(1000))));
...
const testConcatMap = concatValues.pipe(concatMap(value => of(value).pipe(delay(1000))));
...
const testSwitchMap = switchValues.pipe(switchMap(value => of(value).pipe(delay(1000))));
...
const testExhaustMap = exhaustValues.pipe(exhaustMap(value => of(value).pipe(delay(1000))));
